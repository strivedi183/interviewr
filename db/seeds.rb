...
h1 = User.create(:name => 'God', :email => 'holl0272@gmail.com', :password => 'a', :password_confirmation => 'a', :address => 'Brooklyn, NY', :phone => ENV['PHONE'], :image => 'http://4.bp.blogspot.com/_VEFwWvYzl1c/TK6c6fk-PTI/AAAAAAAAA8c/V4veB57_XC4/s1600/Kratos_God_of_War_III.jpg', :is_house => true, :balance => 1000 )
